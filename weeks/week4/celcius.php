...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(isset($_POST['cel'])) {
            ...
            $cel = $_POST['cel'];
            // new function to make sure values are integers
            $cel_int = intval($cel);
            $far = ($cel_int *9/5) +32;
            ...
            if($cel == NULL) {
                ...
                echo '<p> '.$cel_int.' degress celcius equals '.$far.' degrees fahrenheit 
                <br>
